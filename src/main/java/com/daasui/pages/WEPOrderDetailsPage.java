...
public class WEPOrderDetailsPage extends CommonMethod {
	...
	private static Logger LOGGER = LogManager.getLogger(WEPOrderDetailsPage.class);
	private WEPOrderDetailsPage instance;
	public static String uiVersion = System.getProperty("uiVersion");
	
	public WEPOrderDetailsPage getInstance() throws IOException {
		if (instance==null) {
			synchronized(OrdersListPage.class) {
				if(instance==null) {
					instance = new WEPOrderDetailsPage(DRIVER);
				}
	...
	public WEPOrderDetailsPage(WebDriver driver) throws IOException {
		ordersDetailsPageProperties = ordersDetailsPagePropertiesReader.getObjectRepository("WEPOrdersDetailsPageV3");
	}
