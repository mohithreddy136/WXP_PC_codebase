 ...
 *
 */
public class WXPPartnerAnalyticsPage extends CommonMethod {
	private Properties selectedLanguageProperties;
	private ObjectReader partnerAnalyticsPagePropertiesReader = new ObjectReader();
	private Properties partnerAnalyticsPageProperties;
	private Properties partnerAnalyticsDataProperties;
	private Properties partnerAnalyticsTabTitleProperties;
	private final static Logger LOGGER = LogManager.getLogger(WXPPartnerAnalyticsPage.class);
	private WXPPartnerAnalyticsPage instance;
	//private Object reportFlag;
	public static String uiVersion = System.getProperty("uiVersion");
	public WXPPartnerAnalyticsPage getInstance() throws IOException {
		if (instance == null) {
			synchronized (WXPPartnerAnalyticsPage.class) {
				if (instance == null) {
					instance = new WXPPartnerAnalyticsPage(DRIVER);
				}
			}
		}
		return instance;
	...
	public WXPPartnerAnalyticsPage(WebDriver driver) throws IOException {
		partnerAnalyticsDataProperties = partnerAnalyticsPagePropertiesReader.getObjectRepository("WXPPartnerAnalyticsData");
		partnerAnalyticsTabTitleProperties = partnerAnalyticsPagePropertiesReader.getObjectRepository("WXPPartnerAnalyticsTabTitles");
		partnerAnalyticsPageProperties = partnerAnalyticsPagePropertiesReader.getObjectRepository("WXPPartnerAnalyticsPage");
	}

	public final String getTextLanguage(String language, String localefolder, String key) throws Exception {
		selectedLanguageProperties = partnerAnalyticsPagePropertiesReader.getLanguageObjectRepository(localefolder, language);
		return selectedLanguageProperties.getProperty(key);
	}

	/**
	 * This method is the method to verify if an element is present on partner analytics page
	 *
	 * @param key - locator of the element
	 * @return - boolean value of whether the element is present
	 */
	public final boolean verifyElementsOfPartnerAnalyticsPage(String key) {
		try {
			return verifyElementIsPresent(partnerAnalyticsPageProperties.getProperty(key));

		} catch (Exception e) {
			LOGGER.error(("Exception occured in method verifyElementsOfPartnerAnalyticsPage " + e.getMessage()));
			return false;
		}
	}
	...
	public final boolean waitForElementsOfAnalyticsPage(String key) throws Exception {
		return verifyElementIsVisible(partnerAnalyticsPageProperties.getProperty(key));
	}

	public final List<WebElement> getElementsTillAllElementsPresentAnalyticsPage(String locator) throws Exception {
		return getElementsTillAllElementsPresent(partnerAnalyticsPageProperties.getProperty(locator));
	}
	...
	public final boolean matchTextOfAnalyticsPage(String key, String Text) throws Exception {
		return verifyTextPresentOnElement(partnerAnalyticsPageProperties.getProperty(key), Text);
	}

	public final boolean verifyElementIsEnableOfAnalyticsPage(String key) throws Exception {
		return verifyElementIsEnable(partnerAnalyticsPageProperties.getProperty(key));
	}

	public final boolean verifyElementIsSelectedOfAnalyticsPage(String key) throws Exception {
		return verifyElementIsSelected(partnerAnalyticsPageProperties.getProperty(key));
	}

	public final String getTextOfAnalyticsPage(String key) throws Exception {
		return getTextBy(partnerAnalyticsPageProperties.getProperty(key));
	}
	...
	public final List<WebElement> getElementsOfAnalyticsPage(String key) throws Exception {
		return getElementsTillAllElementsPresent(partnerAnalyticsPageProperties.getProperty(key));
	}
	
	public final WebElement getElementOfAnalyticsPage(String key) throws Exception {
		return getElement(partnerAnalyticsPageProperties.getProperty(key));
	}
	
	public final boolean waitForPresenceOfElementsOfAnalyticsPage(String key) throws Exception {
		return waitUntillElementIsPresent(partnerAnalyticsPageProperties.getProperty(key));
	}
	
	public final boolean verifyIfElementIsClickableOfAnalyticsPage(String key) throws Exception {
		return verifyElementIsClickable(partnerAnalyticsPageProperties.getProperty(key));
	}
	...
	public final boolean waitForElementsOfAnalyticsPageDynamic(String key, int wait) throws Exception {
		return verifyElementIsVisibleDynamic(partnerAnalyticsPageProperties.getProperty(key), wait);
	}
	
	public final boolean waitUntilElementIsVisibleOfAnalyticsPageDynamic(String key, int wait) throws Exception {
		return waitUntilElementIsVisibleDynamic(partnerAnalyticsPageProperties.getProperty(key), wait);
	}
	...
	public final void waitUntilElementIsInvisibleOfAnalyticsPage(String key) {
		try {
			verifyElementIsinvisibile(partnerAnalyticsPageProperties.getProperty(key));
		} catch (Exception e) {
	...
	public final boolean selectElementFromDropDownOfAnalyticsPage(String dropdownId, String key, String text) {
		try {
			click(partnerAnalyticsPageProperties.getProperty(dropdownId));
			if(dropdownId.equalsIgnoreCase("paginationDropdown")) {
					jsDriver().executeScript("scroll(0, 750);");
					sleeper(2000);
			}
			return selectFromDropdown(partnerAnalyticsPageProperties.getProperty(dropdownId), partnerAnalyticsPageProperties.getProperty(key), text);
		} catch (Exception e) {
	...
	public final void selectFilterCriteriaForAnalyticsPage(String criteriaOption){
		try{
			...
			if (isVisibleFilterOption == true){
				selectTextValueFromDropdownWorkflow(partnerAnalyticsPageProperties.getProperty("filterFieldOptionList"), criteriaOption,
						partnerAnalyticsPageProperties.getProperty("criteriaFieldDropdown"));
				...
				if (isVisibleFilterValue == true){
					String filterValue = selectFirstValueFromDropdown(partnerAnalyticsPageProperties.getProperty("filterFieldValueOptionList"));
	...
	public final ArrayList<String> createReport(String Category, String subcategory, String options, String reportName,
		...
		try {
			...
			sleeper(3000);
			if (!getDriver().findElements(By.xpath(partnerAnalyticsPageProperties.getProperty("deleteFilter")))
					.isEmpty()) {
				do {
					scrollTillViewAnalyticsPage("optionDropdown");
					getDriver().findElement(By.xpath(partnerAnalyticsPageProperties.getProperty("deleteFilter")))
							.click();
				} while (getDriver()
						.findElements(By.xpath(partnerAnalyticsPageProperties.getProperty("deleteFilter")))
						.size() != 0);
			}
		} catch (Exception e) {
 ...
 */
	...
	public final boolean checkChildCompaniesOnAnalyticsPage(String Category, String subcategory, String options, String reportName, String languageCode){
		...
		try {
			...
			selectTextValueFromDropdownWorkflow(partnerAnalyticsPageProperties.getProperty("filterFieldOptionList"), "Company Preference Key", partnerAnalyticsPageProperties.getProperty("filterFieldForCompanyPreference"));
			sleeper(1000);
	...
	public String[][] getReportTabDetails(String[] reportTabs) throws Exception {
		...
		try {
			for (int i = 0; i < reportTabs.length; i++) {
				temp = partnerAnalyticsDataProperties.getProperty(reportTabs[i]).split(":");
	...
	public boolean reportDataValidation(String[][] tabNameDetails, String[] columnNameKeys, String LanguageCode,
		...
		try {
			...
			scrollTillViewAnalyticsPage("reportTabslist");
			List<WebElement> element = getElementsTillAllElementsPresentAnalyticsPage("reportTabslist");
	...
	public boolean validateColumnNames(String[] columnNameKey, String LanguageCode, String folderName,
		...
		try {
			...
			for (int i = 0; i <= (columnNameKey.length) - 1; i++) {
				expectedColumnNameList = partnerAnalyticsTabTitleProperties.getProperty(columnNameKey[i]).split(":");
	...
	public boolean validateColumnNames_bromium(String[] columnNameKey, String LanguageCode, String folderName, String tabName) throws Exception {
		...
		try {
			for (int i = 0; i <= (columnNameKey.length) - 1; i++) {				
				columnNameList = partnerAnalyticsTabTitleProperties.getProperty(columnNameKey[i]).split(":");
				if(tabName.equalsIgnoreCase(getTextLanguage(LanguageCode, "MPI-Reporting-report-html-view-UI-JSON","details"))) {					
	...
	public final List<String> getTextOfListOnAnalyticsPage(String key) throws Exception {
		return getTextOfList(partnerAnalyticsPageProperties.getProperty(key));
	}
	...
	*/
	...
	public final Object[][] scheduleReport(String languageCode, String category, String subcategory, String options, String reportName, String reportFormat, String recurrence, String recurrenceStringOnCustomTab) throws Exception {
		...
		try {
			...
			selectTextValueFromDropdown(partnerAnalyticsPageProperties.getProperty("recurrenceDropDownList"), recurrence, partnerAnalyticsPageProperties.getProperty("recurrenceDropDownBox"));
	...
	public final Object[][] scheduleReportChildCompany(String languageCode, String category, String subcategory, String options, String reportName, String reportFormat, String recurrence, String recurrenceStringOnCustomTab, String childComp) throws Exception {
		...
		try {
			...
			sleeper(1000);
			clickOnElementsOfAnalyticsPage("filterFieldForCompanyPreferenceValue");
			selectTextValueFromDropdownWorkflow(partnerAnalyticsPageProperties.getProperty("filterFieldValueOptionList"), childComp, partnerAnalyticsPageProperties.getProperty("filterFieldForCompanyPreferenceValue"));
			sleeper(1000);
	...
	public final void mouseHoverOnWorkflowAnalyticsPage(String key) throws Exception {
		mouseHover(partnerAnalyticsPageProperties.getProperty(key));
	}
	...
	public final void selectNumberOfReportsToBeVisibleWorkflow(String dropDownOptions,String dropDown,String optionToSelect) {
		try {
			selectTextValueFromDropdownWorkflow(partnerAnalyticsPageProperties.getProperty(dropDownOptions), optionToSelect, partnerAnalyticsPageProperties.getProperty(dropDown));
			waitUntilElementIsVisibleOfAnalyticsPage("spinner");
		}catch(Exception e) {
	...
	public final void enterTextForAnalyticsPageUsingJavaScript(String key, String Text) throws Exception {
		enterTextUsingJavaScript(partnerAnalyticsPageProperties.getProperty(key), Text);
	}
	...
	public final boolean verifyReportNameChange(String Category, String subcategoryOriginal,String subcategory, String languageCode) throws Exception {
		...
		try {
			...
			selectTextValueFromDropdownWorkflow(partnerAnalyticsPageProperties.getProperty("subcategoryDropdownListWorkflow"), subcategory, partnerAnalyticsPageProperties.getProperty("subcategoryDropdownWorkflow"));
	...
	public boolean reportDataValidationForWorkflow(String[][] tabNameDetails, String[] columnNameKeys, String LanguageCode, String folderName) throws Exception {
		...
		try {
			...
			scrollTillViewAnalyticsPage("reportTabslistWorkflow");
			List<WebElement> element = getElementsTillAllElementsPresentAnalyticsPage("reportTabslistWorkflow");
			for (index = 0; index < tabName.size(); index++) {
				for (WebElement tab : element) {
	...
	public final void mouseHoverbyoffsettClick(String key,int left,int right) throws Exception {
		mouseHoverbyoffsetClick(partnerAnalyticsPageProperties.getProperty(key),left,right);
    }
	...
	public final boolean reportDataValidationVRE(String[] reportTabs, String[] columnNameKeys, String languageCode,
		...
		try {
			List<WebElement> reportTabList = getElementsTillAllElementsPresentAnalyticsPage("reportTabslist");
	...
	public boolean verifyTitleofGridPage(String titleLocatorKey, String titleText) {
		boolean flag = false;
		try {
			if (verifyElementIsVisible(partnerAnalyticsPageProperties.getProperty(titleLocatorKey))) {
...
public final boolean verifyRunReportAndDatatest(ArrayList<String> reportGenerateValues, String LanguageCode) throws Exception {
	try {
		WXPPartnerAnalyticsPage analyticsPage = new WXPPartnerAnalyticsPage(PreDefinedActions.getDriver()).getInstance();
...
public final boolean verifyGridColumnValues(String tab, String columnname, String value) {
	...
	public boolean verifyListofElementsOfAnalyticsPage(String key) {
		...
		try
		{
			List<WebElement> we = getElementsTillAllElementsPresent(partnerAnalyticsPageProperties.getProperty(key));
			for(WebElement w: we)
			{
	...
	public boolean verifyPageSize(String key) throws Exception {
		String pageSize = getTextBy(partnerAnalyticsPageProperties.getProperty(key));
	 ...
	 */
	public final boolean matchTextOfPartnerAnalyticsPage(String key, String textToMatch) {
		try {
			return verifyTextPresentOnElement(partnerAnalyticsPageProperties.getProperty(key), textToMatch);
		} catch (Exception e) {
			LOGGER.error(("Exception occured in method matchTextOfPartnerAnalyticsPage " + e.getMessage()));
			return false;
		}
	}
